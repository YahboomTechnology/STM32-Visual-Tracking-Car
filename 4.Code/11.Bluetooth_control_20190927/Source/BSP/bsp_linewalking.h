...
/*
Looking forward from the back of the car body:
The left to right line sensor parameters are in order L1  L2|black line| R1  R2
Corresponding schematic IN2 IN1 |black line| IN3 IN4
*/
