...
void Protocol(void)
{
	...
	if (StringFind((const char *)ProtocolString, (const char *)"4WD", 0) == -1)
	{
		...
		if (g_CarState != enTLEFT && g_CarState != enTRIGHT)
		{
			...
			{
				case run_car:   g_CarState = enRUN; Angle_J1 = 100; break;
				case back_car:  g_CarState = enBACK; Angle_J1 = 100; break;
				case left_car:  g_CarState = enRUN; Angle_J1 = 50; break;
				case right_car: g_CarState = enRUN; Angle_J1 = 140; break;
				case stop_car:  g_CarState = enSTOP; Angle_J1 = 100; break;
		...
		switch (g_CarState)
		{
			...
			case enRIGHT: Angle_J1 = 140; MiniCar_Run(CarSpeedControl); break;
			case enBACK: MiniCar_Back(CarSpeedControl); break;
			
			
			case enTLEFT: Angle_J1 = 50;MiniCar_lfRun(CarSpeedControl); break;
			case enTRIGHT: Angle_J1 = 140; MiniCar_rfRun(CarSpeedControl); break;
